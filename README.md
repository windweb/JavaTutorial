...
# Курс "Основы Java и практикум решения задач на Java"

В курсе узнаем основы программирования на языке Java и освоим ключевые концепции и навыки.

## Прогресс Курса "Основы Java и практикум решения задач на Java" by Stepik

Курс состоит из 11 модулей, каждый из которых покрывает разные аспекты программирования на Java. Модули и их содержание:

# Курс "Основы Java и практикум решения задач на Java"

Этот репозиторий содержит материалы для прохождения курса "Основы Java и практикум решения задач на Java" на [Stepik](https://stepik.org/180585). В этом курсе вы узнаете основы программирования на языке Java и освоите ключевые концепции и навыки.
...
- [ ] 1.Основы работы с языком Java
    * В данном модуле описываются принципы языка Java и его отличия от других языков программирования, дается помощь с правильной установкой Java на компьютер для удобного дальнейшего использования и разбирается базовый синтаксис программы на Java.
    ...
    - [ ] 1.3 Первая программа на Java. Hello, World!
